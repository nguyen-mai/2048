...
final Map<int, Color>boxColor=<int ,Color>{
  ...
  32:Colors.green[400],
  64:Colors.green[500],
  128:Colors.green[600],
  256:Colors.green[700],
  512:Colors.green[800],
  1025:Colors.green[900],
};
...
class _GameWidgetState extends State<GameWidget>{
  ...
  final EdgeInsets _gameMargin = EdgeInsets.fromLTRB(20.0,30.0,20.0,20.0);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
            margin: EdgeInsets.fromLTRB(20.0, 50.0, 0.0, 20.0),
